...
<?= $this->section('right') ?>
    <div class="container-fluid">
        ...
        <h3 class="text-center py-2" style="background-color: #eeeeee">Create Book</h3>
        <div class="container">
            <div class="row mb-5 px-5 py-4" style="background-color: #fafafa">
                <form enctype="multipart/form-data" action="" method="POST">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <span class="text-danger"><?= display_error($validation,'description'); ?></span>
                    </div>
                    <div class="form-group mt-3">
                        <label>MRP</label>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <span class="text-danger"><?= display_error($validation,'availability'); ?></span>
                    </div>
                    <div class="form-group mt-3">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <span class="text-danger"><?= display_error($validation,'pages'); ?></span>
                    </div>
                    <div class="form-group mt-3">
                        <label>ISBN No.</label>
                        <input type="text" name="isbn_no" class="form-control" value="<?= set_value('isbn_no') ?>" />
                        <span class="text-danger"><?= display_error($validation,'isbn_no'); ?></span>
                    </div>
                    <div class="form-group mt-3">
